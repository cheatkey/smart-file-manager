...
import { FileExtensionBackground } from '../FileViewer/FileBackground';
    ...
    <div className="overflow-hidden flex flex-row flex-wrap">
      {data.map((item) => (
        <div
          ...
          className="relative w-[300px] h-[270px] overflow-hidden group border-2 border-stone-50 flex items-center justify-center"
        >
